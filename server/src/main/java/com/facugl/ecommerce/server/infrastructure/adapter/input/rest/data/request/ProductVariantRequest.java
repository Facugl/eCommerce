...
public class ProductVariantRequest implements Serializable {
	...
	@NotEmpty(message = "The list of images can not be empty.", groups = {
			CreateProductVariantValidationGroup.class })
	...
	@NotNull(message = "Product ID can not be null.", groups = { CreateProductVariantValidationGroup.class })
