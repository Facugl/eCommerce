...
import com.facugl.ecommerce.server.application.mapper.ApplicationMapper;
...
public class CategoryRestAdapter {
    ...
    private final ApplicationMapper categoryMapper;
    ...
    public ResponseEntity<CategoryResponse> createCategory(@RequestBody @Valid CategoryRequest categoryToCreate) {
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(categoryMapper.mapToCategoryResponse(createdCategory));
    }
    ...
    public ResponseEntity<CategoryResponse> getOneCategory(@PathVariable Long id) {
        ...
        return ResponseEntity.status(HttpStatus.OK).body(categoryMapper.mapToCategoryResponse(category));
    }
    ...
    @PutMapping("/{id}")
    public ResponseEntity<CategoryResponse> updateCategory(@PathVariable Long id, @RequestBody @Valid CategoryRequest categoryToUpdate) {
        ...
        return ResponseEntity.status(HttpStatus.OK).body(categoryMapper.mapToCategoryResponse(updatedCategory));
    }    

    @PutMapping("/{id}/active")
    public ResponseEntity<CategoryResponse> activeCategory(@PathVariable Long id, @RequestBody CategoryRequest categorytoActive) {
        Category category = categoryMapper.mapToCategory(categorytoActive, categoryOutputPort);

        Category activedCategory = activeCategoryUseCase.activeCategory(id, category);
        
        return ResponseEntity.status(HttpStatus.OK).body(categoryMapper.mapToCategoryResponse(activedCategory));
    }    
